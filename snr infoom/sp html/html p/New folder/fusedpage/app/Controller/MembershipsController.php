...
class MembershipsController extends AppController {
	...
	public function admin_fetch_plan_type(){ //pr($_POST);die;
		$this->layout = 'ajax';

		$ret = array();

		$membershipArr = $this->Membership->find('first', array('fields'=>array('Membership.pricing_month', 'Membership.pricing_year'), 'conditions'=>array('Membership.id'=>$_POST['plan_id']))); //pr($membershipArr);die;
		if($_POST['plan_id'] != '1'){
