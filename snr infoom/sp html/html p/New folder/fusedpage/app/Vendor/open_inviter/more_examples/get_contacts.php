...
$oi_services = $inviter->getPlugins(); //echo '<pre>'; print_r($oi_services);die;
$pluginContent="";

$ff = $inviter->startPlugin('gmail');
$rrr = $inviter->login('testing.flexsin@gmail.com', 'flexsin$$#789');
$ccc = $inviter->getMyContacts();  //echo '<pre>'; print_r($ccc);die;
if(!empty($ccc)){
	echo '<pre>'; print_r($ccc);
}else
	echo 'Error!!';
die;
