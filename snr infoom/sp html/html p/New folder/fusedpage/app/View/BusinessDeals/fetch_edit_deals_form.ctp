...
<span class="insidehd" style="font-size:15px;">Edit Deal</span>
<div class="contactwebsitename">&nbsp;</div>

<?php echo $this->Form->hidden('BusinessDeal.id', array('value'=>$businessArr['BusinessDeal']['id']));?>
<div class="contectflbox" style="width:400px;">
	...
	<div class="contactfield" style="float:left;">
		<?php echo $this->Form->text('BusinessDeal.title', array('div'=>false, 'label'=>false, 'class'=>'contactinput addOfferClass', 'maxlength'=>200, 'value'=>$businessArr['BusinessDeal']['title']));?>
	...
	<div class="contactfield" style="float:left;">
		<?php echo '$ '.$this->Form->text('BusinessDeal.price', array('div'=>false, 'label'=>false, 'class'=>'contactinput_1 addOfferClass', 'value'=>$businessArr['BusinessDeal']['price']));?>
	...
	<div class="contactfield" style="float:left;">
		<?php echo $this->Form->text('BusinessDeal.tagline', array('div'=>false, 'label'=>false, 'class'=>'contactinput addOfferClass', 'maxlength'=>255, 'value'=>$businessArr['BusinessDeal']['tagline']));?>
	...
	<div class="contacttextfied" style="float:left; height:auto;">
		<?php echo $this->Form->textarea('BusinessDeal.description', array('div'=>false, 'label'=>false, 'class'=>'contacttextarea addOfferClass', 'rows'=>'', 'cols'=>'', 'value'=>$businessArr['BusinessDeal']['description']));?>
	...
	<div id="showDealUploading" style="float:right; width:100px;"><?php
		if($businessArr['BusinessDeal']['image'] != ''){
			$imagePath = '../webroot/img/front_end/business/deals/'.$businessArr['BusinessDeal']['image'];
			if(is_file($imagePath)){
				$image = 'front_end/business/deals/'.$businessArr['BusinessDeal']['image'];
				echo $this->Image->resize($image, 50, 50, array('alt'=>''));
			}
		}
	?></div>
	<div class="clr"></div>
	...
	<div class="contacttextfied" style="float:left; height:auto;">
		<?php echo $this->Form->textarea('BusinessDeal.fine_prints', array('div'=>false, 'label'=>false, 'class'=>'contacttextarea addOfferClass', 'rows'=>'', 'cols'=>'', 'value'=>$businessArr['BusinessDeal']['fine_prints']));?>
	...
	<div class="contacttextfied" style="float:left; height:auto;">
		<?php echo $this->Form->textarea('BusinessDeal.high_lights', array('div'=>false, 'label'=>false, 'class'=>'contacttextarea addOfferClass', 'rows'=>'', 'cols'=>'', 'value'=>$businessArr['BusinessDeal']['high_lights']));?>
	...
	<div class="contactfield" style="float:left;">
		<?php echo $this->Form->text('BusinessDeal.start_date', array('div'=>false, 'label'=>false, 'class'=>'contactinput addOfferClass', 'maxlength'=>255, 'readonly'=>'readonly', 'value'=>$businessArr['BusinessDeal']['start_date']));?>
	...
	<div class="contactfield" style="float:left;">
		<?php echo $this->Form->text('BusinessDeal.end_date', array('div'=>false, 'label'=>false, 'class'=>'contactinput addOfferClass', 'maxlength'=>255, 'readonly'=>'readonly', 'value'=>$businessArr['BusinessDeal']['end_date']));?>
	...
	<div class="contactfield" style="padding-top:10px; float:left;">
		<div style="float:left; width:130px;">
			<?php echo $this->Form->submit('front_end/submit_btn.png', array('div'=>false, 'onclick'=>'validateEditDealsForm();'));?>
		</div>
...
$(document).ready(function(){ //alert('test');
	...
	new AjaxUpload(BusinessDealImage1, {
		action: "<?php echo SITE_PATH.'business_deals/edit_image/';?>",
		name: "image",
		data: {"id":"<?php echo $businessArr['BusinessDeal']['id'];?>", "old_image":"<?php echo $businessArr['BusinessDeal']['image'];?>"},
