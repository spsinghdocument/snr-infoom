...
<div class="popupflimg" style="background-color:#FFFFFF;">
	...
	<div style="margin-top:10px;"><a href="<?php echo $this->Fused->validateLink($businessArr['BusinessFeed']['link']);?>" target="_blank" style="text-decoration:none; color:#1C87D4;"><?php echo $businessArr['BusinessFeed']['link'];?></div>
</div>
<!-- LEFT SECTION END -->
