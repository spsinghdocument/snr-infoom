...
<span style="color:#0273C4;"><strong>Recommended Friends</strong></span>
	<div class="peopeimgbox">
			...
			<?php $GroupUserImageArr = $this->Fused->fetchGroupUserImage($this->Fused->decrypt($this->params['pass'][0]));
								foreach($GroupUserImageArr as $GroupUserImage){
									$username = $GroupUserImage['User']['username'];
				...
				<div class="peopleimgboxsml">
					<a href="<?php echo SITE_PATH.'users/profile/'.$username.'/';?>"><?php echo $this->Image->resize($groupImage, 32, 32, array('alt'=>'')).' '; ?></a>
				</div>
