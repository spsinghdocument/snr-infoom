...
function validate_group_post(){
		...
		$.ajax({
			...
			data: "group_user_id="+group_user_id+"&group_id="+group_id+"&image="+image+"&video="+video+"&link="+link+"&message="+message+"&social_medias="+social_medias+"&image_caption="+image_caption+"&video_caption="+video_caption+"&link_caption="+link_caption+"&youtube_link="+youtube_link+"&yotube_type="+yotube_type,
			beforeSend:function(){
