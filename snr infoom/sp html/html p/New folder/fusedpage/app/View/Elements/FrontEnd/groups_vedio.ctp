<div id="pulic_5" style="display:none;">
	...
	<div id="main_listing_video_container">
		...
		?>
			<div id="photo_container_<?php echo $video['GroupGallery']['id'];?>" class="<?php echo $class;?>">
				<div class="vedioicon">
				...
				<div class="photo_del_box">
					<?php echo $this->Html->link($this->Html->image('front_end/delete.png', array('alt'=>'')), 'javascript:void(0);', array('escape'=>false, 'onclick'=>"deletePhoto('".$video['GroupGallery']['id']."', 'video')"));?>
				</div>
				<?php } ?>
			</div>
		<?php	echo $dir;
