	...
	<div class="priceboxmid">
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
		  <tr class="lightbue">
			...
			<td width="20%" id="pp_1" class="plan_details">Contact Us</td>
		  </tr>
		  <tr class="bluebg">
		  ...
		  <tr class="bluebg">
			...
			<td width="20%" id="p_10" class="plan_details"><?php echo $plansArr[2]['Membership']['push_marketing'];?></td>
...
function validatePlan(alias_name){
	<?php if($businessArr['Business']['request_sent'] == $this->Session->read('Auth.User.User.id')){?>
		if((alias_name == 'basic_plus') || (alias_name == 'premium') || (alias_name == 'premium_plus'))
	<?php }else{?>
	...
	<?php } ?>
	{
		...
		$.ajax({
			type: "POST",
			url: "<?php echo $https_site_path.'memberships/fetch_membership_data/';?>",
