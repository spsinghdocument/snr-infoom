<?php if($this->Session->check('Auth.User.User.id')){?>
	...
	<div class="ratingbox" id="rating_box" style="float:right;">
		<span id="userRatingSpan">
			<?php
				/* for($i=1; $i<=5; $i++){
			...
			<div class="exemple" style="float:right;"><div class="exempleoverAll" data="<?php echo $businessArr['Business']['rating'];?>_5"></div></div>
		</span>
	</div>
