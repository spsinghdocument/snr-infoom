<div style="margin:20px 5px 5px 5px; font-family:Arial,Helvetica,sans-serif; font-size:12px; color:#000000;">
	...
	<?php echo $this->Session->read('Auth.User.User.first_name').' '.$this->Session->read('Auth.User.User.last_name');?> has  invited you to join on fusedpage.com and has left you a message as,<br/><br/>
