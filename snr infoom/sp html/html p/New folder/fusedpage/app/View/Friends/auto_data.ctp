...
<div>
<?php 
		foreach($searchArr as $searchArr){ //pr($searchArr);
...
<div class="friendmainbox">
					...
					<div class="friendsharelink" id="sent_request111" style="margin-left:85px; margin-top:5px;"><a href="JavaScript:void(0);" style="padding-left:0; color:green;">Friend Requested</a></div>
					...
					<?php } else { ?>
					<div class="friendsharelink" id="sent_request_<?php echo $searchArr['User']['id']; ?>" style="margin-left:85px; margin-top:5px;"><a href="JavaScript:void(0);" onclick="sent_request('<?php echo $searchArr['User']['id']; ?>');" style="padding-left:0;">Add As Friend</a></div>
					<div class="friendsharelink" id="sent_request1_<?php echo $searchArr['User']['id']; ?>" style="display:none; margin-left:85px; margin-top:5px;"><a href="JavaScript:void(0);" style="padding-left:0; color:green;">Friend Request Sent</a></div> 
					<?php } }?>
