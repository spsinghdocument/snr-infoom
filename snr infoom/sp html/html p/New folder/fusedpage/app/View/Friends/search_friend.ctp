	...
	?>
				...
				<div class="<?php echo $class; ?>">
					...
					<div class="friendfrbox">
						...
						<div class="friendsharelink" id="sent_request1_search_<?php echo $listing['User']['id']; ?>"><a href="JavaScript:void(0);" style="padding-left:0; color:green;">Request Sent</a></div>
						<?php } else if($received_friend['Friend']['friendship_status'] == '1') { ?>
						<div class="friendsharelink" id="sent_request_search_<?php echo $listing['User']['id']; ?>"><a href="JavaScript:void(0);" style="padding-left:0; color:red;" onclick="return unfriend('<?php echo $received_friend['Friend']['id']; ?>');">Unfriend</a></div>
						<?php } else { ?>
						<div class="friendsharelink" id="sent_request_search_<?php echo $listing['User']['id']; ?>"><a href="JavaScript:void(0);" onclick="sent_request('<?php echo $listing['User']['id']; ?>');" style="padding-left:0;">Add As Friend</a></div>
						<?php } ?>
						<div class="friendsharelink" id="sent_request1_search_<?php echo $listing['User']['id']; ?>" style="display:none;"><a href="JavaScript:void(0);" style="padding-left:0; color:green;">Friend Requested</a></div>
