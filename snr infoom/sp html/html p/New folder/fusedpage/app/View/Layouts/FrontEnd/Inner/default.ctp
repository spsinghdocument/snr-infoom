...
<div id="wrapper">
	...
	<div class="insidemain">
		...
		<div class="midinsidemain">
			<?php if($this->params['action'] != 'membership_plans' && $this->params['action'] != 'invite_friends' && $this->params['action'] != 'how_it_works'){?>
			...
			<?php } ?>
				...
				<div class="clr"></div>
			<?php if($this->params['action'] != 'membership_plans' && $this->params['action'] != 'invite_friends'){?>
			</div>
			<?php } ?>
		</div>
