...
<div class="rightMid">
	...
	?>
		...
		<?php if(($this->data['Membership']['id'] == 3) || ($this->data['Membership']['id'] == 4)){?>
		<div class="formField">
			<span>Advertising Feeds :</span>
			<?php 
				echo $this->Form->input('Membership.advertising_feeds', array('div'=>false, 'label'=>false, 'type'=>'text', 'class'=>'formInput validate[required,custom[integer]]', 'maxlength'=>10, 'error'=>false, 'style'=>'width:18%'));
			?>
		</div>
		<?php } ?>
