...
<div class="mainHd" style="font-size:15px;">
	<?php echo $this->Form->create('Payment', array('action'=>'admin_search'));?>
...
<div class="rightMid">
	...
	<!-- DISPLAY MESSAGE END -->
	<div class="mainHd">Manage Payments</div>
	...
	<?php 
		...
		<div style="text-align:center; color:#FF0000;">No Payment Made Yet!!</div>
	<?php } ?>
	<div class="clr"></div>
</div>
