...
<div id="main" style=" width:700px;">
	...
	<fieldset>
		...
		<div class="fielddiv">
			<div class="fielddiv1">Country:</div>
			<div class="fielddiv2"><?php echo $userArr['Country']['countries_name'];?></div>
		</div>
		<div class="clear"></div>

		<div class="fielddiv">
			<div class="fielddiv1">State:</div>
			<div class="fielddiv2"><?php echo $userArr['User']['state'];?></div>
		</div>
		<div class="clear"></div>

		<div class="fielddiv">
			<div class="fielddiv1">City:</div>
			<div class="fielddiv2"><?php echo $userArr['User']['city'];?></div>
		</div>
		<div class="clear"></div>
		...
		<div class="fielddiv">
			<div class="fielddiv1">work:</div>
			<div class="fielddiv2"><?php echo $userArr['User']['work'];?></div>
		</div>
		<div class="clear"></div>
