...
(function($) {
	$.fn.jRating = function(op) {
		var defaults = {
			/** String vars **/
			bigStarsPath : 'http://localhost/fusedpage/img/front_end/rating/stars.png', // path of the icon stars.png
			smallStarsPath : 'http://localhost/fusedpage/img/front_end/rating/small.png', // path of the icon small.png
