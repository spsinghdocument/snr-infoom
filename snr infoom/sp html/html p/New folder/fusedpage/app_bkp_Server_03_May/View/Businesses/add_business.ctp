				...
				<div class="accordion">
					...
					<div class="categoryitems insPad" contentindex="2c" style="display: none;">
						<div class="accwhitebox">
							...
							<div style="background:none; padding-top:11px;" class="formfieldbig validate[required]" id="Banner_parent"><input type="file" size="50" name="data[Business][banners][]"></div>
							<div class="clr"></div>	
