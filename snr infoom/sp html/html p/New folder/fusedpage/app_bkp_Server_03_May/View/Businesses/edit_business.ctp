				...
				<div class="accordion">
					...
					<div class="categoryitems insPad" contentindex="0c" style="display: none;">
						<div class="accwhitebox">
							...
							<div class="formfieldbig"><input type="text" class="forminputbig validate[,custom[url]" name="data[Business][website]" value=""></div>
				...
				<div class="accordion">
					...
					<div class="categoryitems insPad" contentindex="2c" style="display: none;">
						<div class="accwhitebox">
							...
							<div style="background:none; padding-top:11px;" class="formfieldbig validate[required]" id="Banner_parent">
							<?php
								//validate the banners as per the membership plan
								$multiple = '';
								if($businessPlan != 1)
									$multiple = 'multiple="multiple"';
							?>
							<input type="file" size="50" name="data[Business][banners][]" <?php echo $multiple;?>>
							</div>
