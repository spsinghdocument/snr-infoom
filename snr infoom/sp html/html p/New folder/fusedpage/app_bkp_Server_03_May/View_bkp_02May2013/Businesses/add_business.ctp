				...
				<div class="accordion">
					...
					<div class="categoryitems insPad" contentindex="0c" style="display: none;">
						<div class="accwhitebox">
							...
							<div class="formfieldbig"><input type="text" class="forminputbig" id="BusinessCity" name="data[Business][city]" readonly=readonly>
							...
							<div class="textareabox"><textarea class="textareaboxinput" rows="" cols="" name="data[Business][hours]"></textarea></div>
