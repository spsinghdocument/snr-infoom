...
<div class="midinsidemain">
			...
			<?php echo $this->Form->create('Business', array('action'=>'edit_business', 'type'=>'file','id'=>'AddBusiness')); ?>
			...
			<div class="businesstobg">
				<div class="businesstoinputbox">
				 ...
				 <div class="questionmark"><a onmouseout="hideTip()" onmouseover="doTooltip(event,0)" href="#"><img alt="" src="/fusedpage/img/add business/question_mark_icon.jpg"></a></div>
				<div class="clr"></div>
				</div>
				<div class="businesstoinputbox">
				 <div class="formlabletopfr">Catgory:</div>
			...
			<div align="center"><img alt="" src="/fusedpage/img/add business/business_btm_shadow.jpg"></div>
			<!--End business box -->
			...
			<div>
				...
				<div class="accordion">
					...
					<div class="categoryitems insPad" contentindex="0c" style="display: none;">
						<div class="accwhitebox">
							...
							<div class="questionmark"><a onmouseout="hideTip()" onmouseover="doTooltip(event,1)" href="#"><img alt="" src="/fusedpage/img/add business/question_mark_icon.jpg"></a></div>
							<div class="clr"></div>
							...
							<div class="formfieldbig"><input type="text" class="forminputbig validate[,custom[url]" name="data[Business][website]" value="<?php echo $this->data['Business']['website']; ?>"></div>
							<div class="questionmark"><a onmouseout="hideTip()" onmouseover="doTooltip(event,2)" href="#"><img alt="" src="/fusedpage/img/add business/question_mark_icon.jpg"></a></div>
							<div class="clr"></div>
							<div class="formlablebig">Hours:</div>
							<div class="textareabox"><textarea class="textareaboxinput" rows="" cols="" name="data[Business][hours]" ><?php echo $this->data['Business']['hours']; ?></textarea></div>
							<div class="questionmark"><a onmouseout="hideTip()" onmouseover="doTooltip(event,3)" href="#"><img alt="" src="/fusedpage/img/add business/question_mark_icon.jpg"></a></div>
							<div class="clr"></div>
						</div>	
					</div>
				</div>
				...
				<div class="accordion">
					<div class="menuheader expandable" headerindex="2h"><span class="accordprefix"></span>
						<div class="accordion"><a href="javascript://">Business Banner</a></div>
					<span class="accordsuffix"></span></div>
					<div class="categoryitems insPad" contentindex="2c" style="display: none;">
						<div class="accwhitebox">
							...
							<?php echo $this->Html->image("front_end/business/banners/".$this->data['Business']['banner'],array("height"=>'100px','width'=>'100px'));?>
							<div class="clr"></div>	
				...
				<div class="accordion">
					...
					<div class="categoryitems insPad" contentindex="3c" style="display: none;">
						<div class="accwhitebox">
							...
							<div class="textareabox"><textarea class="textareaboxinput" rows="" cols="" name="data[Business][about_us]"></textarea></div>
							<div class="clr"></div>	
						</div>	
					</div>
				</div>
			</div>		
			<div align="center" style="padding-top:15px;"><?php echo $this->Form->submit('add business/submit_btn.png'); ?></div>		
			</div>
			</form>
		      </div>
			<!--End according part -->
