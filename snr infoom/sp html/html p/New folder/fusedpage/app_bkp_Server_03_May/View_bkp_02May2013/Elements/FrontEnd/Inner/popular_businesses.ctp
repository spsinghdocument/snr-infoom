...
<div class="deshboardfr">
	...
	<div class="insidefrbox">
		<div class="feddimgbox">
			<?php echo $this->Html->link($this->Image->resize($businessImage, 57, 57, array('alt'=>'')), '/businesses/details/'.base64_encode($listing['Business']['id']).'/'.$listing['Business']['alias_name'].'/', array('escape'=>false));?>
		</div>

		<div class="bussinesflbox">
			<div class="multipalhd">
				<?php echo $this->Html->link($this->Text->truncate($listing['Business']['title'], 15, array('ending'=>'...', 'exact'=>true, 'html'=>true)), '/businesses/details/'.base64_encode($listing['Business']['id']).'/'.$listing['Business']['alias_name'].'/', array('escape'=>false));?>
			</div>
