...
<div class="deshlistbox">
	<div class="offermain">
		...
		<div class="edittext">
			<?php if($this->Fused->validateUserForBusiness() == $offer['BusinessOffer']['business_id']){?>
				<a href="javascript:void(0);" onclick="return validateOffersTabs('<?php echo $offer['BusinessOffer']['id'];?>');" title="Edit"><?php echo $this->Html->image('front_end/edit_icon.png', array('alt'=>''));?> Edit</a>
			<?php } ?>
		</div>
	</div>
	...
	<div class="deshboarlistfrbox">
		...
		<?php if($this->Fused->validateUserForBusiness() == $offer['BusinessOffer']['business_id']){?>
		<span style="float:right;"><a href="javascript:void(0);" title="Delete" onclick="return deleteBusinesOffer('<?php echo $offer['BusinessOffer']['id'];?>');"><?php echo $this->Html->image('admin/delete_icon.gif', array('alt'=>''));?></a></span>
		<?php } ?>
		<!-- DELETE SECTION END -->
