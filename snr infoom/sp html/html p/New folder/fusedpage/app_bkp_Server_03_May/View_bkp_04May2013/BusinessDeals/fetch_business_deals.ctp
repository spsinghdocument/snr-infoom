...
<div class="deshlistbox">
	...
	<div class="dealdtlboxfr">
		...
		<div>
			<div class="viewdtlbtn"><a href="javascript:void(0);"><?php echo $this->Html->image('front_end/view_dtl_btn.png', array('alt'=>''));?></a></div>
	...
	<?php if($this->Fused->validateUserForBusiness() == $deal['BusinessDeal']['business_id']){?>
	<div class="edittext" style="text-align:left;">
		<a title="Edit" href="javascript:void(0);" style="float:left;" onclick="return validateDealsTabs('edit', '<?php echo $deal['BusinessDeal']['id'];?>')"><img alt="" src="/fusedpage/img/front_end/edit_icon.png"> Edit</a>
