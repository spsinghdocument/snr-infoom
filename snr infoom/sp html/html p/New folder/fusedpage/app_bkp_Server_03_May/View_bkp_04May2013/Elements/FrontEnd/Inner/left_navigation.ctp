...
<div class="userdeshboadfl">
	<div class="userdeshboardflin">
		...
		<ul class="deshboardfllist">
			...
			<li><a href="<?php echo SITE_PATH.'favorites/listings/';?>" <?php if(($this->params['controller']=='favorites') && ($this->params['action']=='listings')){echo 'class="sel"';}?>><?php echo $this->Html->image('front_end/favourit_icon.png', array('alt'=>''));?> Favorite<span><?php echo $count; ?></span></a></li>
		</ul>
	</div>
</div>