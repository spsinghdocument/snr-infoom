...
<div class="bussinessinmain" <?php if($i==1){?>style="padding-top:0;"<?php } ?>>
	...
	<div class="busnissfrbox">
		<div class="busnissimgfrinhd">
			<?php echo $this->Html->link($pop_business['Business']['title'], '/businesses/details/'.$this->Fused->encrypt($pop_business['Business']['id']).'/'.$pop_business['Business']['alias_name'].'/', array('escape'=>false));?>
		</div>
