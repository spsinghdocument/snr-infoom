<div style="margin:20px 5px 5px 5px; font-family:Arial,Helvetica,sans-serif; font-size:12px; color:#000000;">
	...
	<strong>Transaction ID:</strong> <?php echo $savePaymentData['transaction_id'];?><br/>
	<strong>Claimed Business:</strong> <?php echo $businessArr['Business']['title'];?><br/>
	<strong>Membership:</strong> <?php echo $membershipArr['Membership']['name'];?><br/>
	<strong>Expires On:</strong> <?php echo date('d M, Y', strtotime($saveMembershipData['expires_on']));?><br/><br/>
