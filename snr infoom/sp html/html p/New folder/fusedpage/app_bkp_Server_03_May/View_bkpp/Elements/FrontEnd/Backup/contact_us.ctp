...
<div id="pulic_6" class="deshlistbox" style="display:none;">	
	...
	<div class="visitedus">
		<strong class="mailus">Visit Us At:</strong>
		<p><?php echo $businessArr['Business']['street'];?></p>
		<p><?php echo $businessArr['Business']['city'];?>, <?php echo $businessArr['Business']['state'];?>, <?php echo $businessArr['Business']['country'];?></p>
		<p><?php echo $businessArr['Business']['phone'];?></p>
	</div>
	<div class="clr"></div>
</div>
...
function validateEnquiryForm(){
	...
	$.ajax({
		...
		data: "subject="+subject+"&business_id=<?php echo base64_decode($this->params['pass'][0]);?>&message="+message,
		beforeSend:function(){
