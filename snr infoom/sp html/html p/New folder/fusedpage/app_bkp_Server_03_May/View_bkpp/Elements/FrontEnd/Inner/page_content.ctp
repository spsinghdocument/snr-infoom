<?php
	$user_id = null;
	//if dashboard is of another user
	if(isset($this->params['id']) && $this->params['id'] != ''){
		$user_id = $this->Fused->fetchUserIdFromUsername($this->params['id']);
	}

	//fetch feeds
	$feedsArr = $this->Fused->fetchUserDashboardFeeds($user_id);
?>
...
<?php } }else{ ?>
	<div class="deshlistbox" align="center" style="margin-top:50px;">
		<a href="<?php echo SITE_PATH.'friends/listings/';?>">Add friends</a> and <a href="<?php echo SITE_PATH.'businesses/listings/';?>">subscribe</a> to business identities for better experience!!
	</div>
<?php } ?>
