			...
			?>
				<div class="<?php echo $class; ?>">
					...
					<div class="friendfrbox">
						<div class="friendhd"><a href="<?php echo SITE_PATH.'users/profile/'.$username.'/';?>"><?php echo $listing[$validModelType]['first_name']." ".$listing[$validModelType]['last_name'].", ".$listing[$validModelType]['city']; ?></a></div>
						<div class="friendsmltext"><?php echo $listing[$validModelType]['state']; ?> </div>
						<?php if($listing['Friend']['friendship_status'] == '0'){ ?>
						<div class="friendsharelink"><a href="JavaScript:void(0);" style="padding-left:0; color:green;">Friend Requested</a>|<a href="JavaScript:void(0);" onclick="return unfriend('<?php echo $listing['Friend']['id']; ?>');" style="color:red;">Unfriend</a></div>
						<?php } else { ?>
						<div class="friendsharelink"><a href="JavaScript:void(0);" onclick="return unfriend('<?php echo $listing['Friend']['id']; ?>');" style="color:red; padding-left:0;">Unfriend</a></div>
						<?php } ?>
					</div>
				</div>
				<?php echo $class1; ?>
